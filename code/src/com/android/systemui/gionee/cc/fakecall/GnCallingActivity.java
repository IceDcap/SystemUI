...
public class GnCallingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initNotifyMessage();
        GnFakeCallHelper virtualCallHelper = GnFakeCallHelper.getInstance();
    ...
    private void createMediaPlayerByVoiceFileId() {
        ...
        mMediaPlayer = MediaPlayer.create(GnCallingActivity.this, getVoiceResId());
    ...
    protected class DelayHandler extends Handler {
        ...
        private void handleRefreshCallTime(String timeDuration) {
            String str = GnCallingActivity.this.getResources().getString(R.string.gn_fc_incall);
