...
import static com.android.systemui.gionee.cc.qs.policy.GnBluetoothUtil.connectionStateToString;
import static com.android.systemui.gionee.cc.qs.policy.GnBluetoothUtil.deviceToString;
import static com.android.systemui.gionee.cc.qs.policy.GnBluetoothUtil.profileStateToString;
import static com.android.systemui.gionee.cc.qs.policy.GnBluetoothUtil.profileToString;
import static com.android.systemui.gionee.cc.qs.policy.GnBluetoothUtil.uuidToProfile;
import static com.android.systemui.gionee.cc.qs.policy.GnBluetoothUtil.uuidToString;
import static com.android.systemui.gionee.cc.qs.policy.GnBluetoothUtil.uuidsToString;
...
import com.android.systemui.gionee.cc.qs.policy.GnBluetoothController.Callback;
import com.android.systemui.gionee.cc.qs.policy.GnBluetoothController.PairedDevice;
import com.android.systemui.gionee.cc.qs.policy.GnBluetoothUtil.Profile;
...
public class GnBluetoothControllerImpl implements GnBluetoothController {
    ...
    public GnBluetoothControllerImpl(Context context) {
        mContext = context;
        ...
        for (int i = 0; i < profiles.size(); i++) {
            ...
            mAdapter.getProfileProxy(mContext, new ServiceListener() {
                ...
                public void onServiceConnected(int profile, BluetoothProfile proxy) {
                    ...
                    final Profile p = GnBluetoothUtil.getProfile(proxy);
                    if (p == null) {
