...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    // Add by wujj
    protected GnNotificationService mGnNotificationService ;
    protected GnNotificationLevelHeader mImportantHeader;
    protected GnNotificationLevelHeader mOtherHeader;
    ...
    private void initGnNotificationService() {
		if (GnNotificationService.SHOW_GNSTYLE_NOTIFICATION == true) {
			mGnNotificationService = GnNotificationService.getService(this);
		}
    }
        ...
        public void handleMessage(Message m) {
            switch (m.what) {
             ...
             case MSG_CLOSE_SEARCH_PANEL:
                 ...
                 break;
             case MSG_UPDATE_NOTIFICATION_HEADER:
	...
	protected void updateClearButton() {
		mHandler.removeMessages(MSG_UPDATE_NOTIFICATION_HEADER);
