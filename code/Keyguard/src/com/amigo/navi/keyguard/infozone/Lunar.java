...
public class Lunar {
    ...
    int[] lunarInfo = {0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554, 0x056a0, 0x09ad0,
            ...
            0x09570, 0x04af5, 0x04970, 0x064b0, 0x074a3, 0x0ea50, 0x06b58, 0x055c0, 0x0ab60, 0x096d5,
    ...
    int[] sTermInfo = {0, 21208, 42457, 63806, 85297, 106944, 128777, 150811, 173019, 195400, 217902, 240498,
            263152, 285789, 308393, 330853, 353200, 375364, 397347, 419120, 440735, 462194, 483512, 504758};
    char[] Gan = {0x7532, 0x4E59, 0x4E19, 0x4E01, 0x620A, 0x5DF1, 0x5E9A, 0x8F9B, 0x58EC, 0x7678};
    char[] tw_Gan = {0x7532, 0x4E59, 0x4E19, 0x4E01, 0x620A, 0x5DF1, 0x5E9A, 0x8F9B, 0x58EC, 0x7678};
    char[] Zhi = {0x5B50, 0x4E11, 0x5BC5, 0x536F, 0x8FB0, 0x5DF3, 0x5348, 0x672A, 0x7533, 0x9149, 0x620C,
            0x4EA5};
    char[] tw_Zhi = {0x5B50, 0x4E11, 0x5BC5, 0x536F, 0x8FB0, 0x5DF3, 0x5348, 0x672A, 0x7533, 0x9149, 0x620C,
            0x4EA5};
//    char[] Animals = {0x9F20, 0x725B, 0x864E, 0x5154, 0x9F99, 0x86C7, 0x9A6C, 0x7F8A, 0x7334, 0x9E21, 0x72D7,
//            0x732A};
//    char[] tw_Animals = {0x9F20, 0x725B, 0x864E, 0x5154, 0x9F8D, 0x86C7, 0x99AC, 0x7F8A, 0x7334, 0x96DE,
//            0x72D7, 0x8C6C};

    char[] solarTerm = {0x5C0F, 0x5BD2, 0x5927, 0x5BD2, 0x7ACB, 0x6625, 0x96E8, 0x6C34, 0x60CA, 0x86F0,
            0x6625, 0x5206, 0x6E05, 0x660E, 0x8C37, 0x96E8, 0x7ACB, 0x590F, 0x5C0F, 0x6EE1, 0x8292, 0x79CD,
            0x590F, 0x81F3, 0x5C0F, 0x6691, 0x5927, 0x6691, 0x7ACB, 0x79CB, 0x5904, 0x6691, 0x767D, 0x9732,
            0x79CB, 0x5206, 0x5BD2, 0x9732, 0x971C, 0x964D, 0x7ACB, 0x51AC, 0x5C0F, 0x96EA, 0x5927, 0x96EA,
            0x51AC, 0x81F3};

    char[] tw_solarTerm = {0x5C0F, 0x5BD2, 0x5927, 0x5BD2, 0x7ACB, 0x6625, 0x96E8, 0x6C34, 0x9A5A, 0x87C4,
            0x6625, 0x5206, 0x6E05, 0x660E, 0x7A40, 0x96E8, 0x7ACB, 0x590F, 0x5C0F, 0x6EFF, 0x8292, 0x7A2E,
            0x590F, 0x81F3, 0x5C0F, 0x6691, 0x5927, 0x6691, 0x7ACB, 0x79CB, 0x8655, 0x6691, 0x767D, 0x9732,
            0x79CB, 0x5206, 0x5BD2, 0x9732, 0x971C, 0x964D, 0x7ACB, 0x51AC, 0x5C0F, 0x96EA, 0x5927, 0x96EA,
            0x51AC, 0x81F3};
    char[] dateStr1 = {0x6B63, 0x4E00, 0x4E8C, 0x4E09, 0x56DB, 0x4E94, 0x516D, 0x4E03, 0x516B, 0x4E5D,
            0x5341, 0x51AC, 0x814A};

    char[] tw_dateStr1 = {0x6B63, 0x4E00, 0x4E8C, 0x4E09, 0x56DB, 0x4E94, 0x516D, 0x4E03, 0x516B, 0x4E5D,
            0x5341, 0x51AC, 0x81D8};
...
//    char[] lFtv = {0x6625, 0x8282, 0x521D, 0x4E8C, 0x5143, 0x5BB5, 0x7AEF, 0x5348, 0x4E03, 0x5915, 0x4E2D,
//            0x5143, 0x4E2D, 0x79CB, 0x91CD, 0x9633, 0x814A, 0x516B, 0x5C0F, 0x5E74, 0x9664, 0x5915};
//
//    char[] tw_lFtv = {0x6625, 0x7BC0, 0x521D, 0x4E8C, 0x5143, 0x5BB5, 0x7AEF, 0x5348, 0x4E03, 0x5915, 0x4E2D,
//            0x5143, 0x4E2D, 0x79CB, 0x91CD, 0x967D, 0x81D8, 0x516B, 0x5C0F, 0x5E74, 0x9664, 0x5915};
    ...
    public Lunar(Time solarTime, Context context) {
        mContext = context;
...
//            return (((lunarInfo[y - 1900] & 0x10000) > 0) ? 30 : 29);
    ...
    int sTerm(int y, int n) {
        ...
        solarTime.set((long) (31556976080l * (y - 1900) + (long) sTermInfo[n] * 60000)
    ...
    public void SetSolarDate(Time solarTime) {
        ...
        int i, leap = 0, temp = 0;
        if (solarTime.year > solarTime.getActualMaximum(Time.YEAR) || solarTime.year < MINYEAR) {
        ...
        int offset = (int) ((long) (Date.UTC(solarTime.year - 1900, solarTime.month, solarTime.monthDay, 0,
                0, 0) - Date.UTC(0, 0, 31, 0, 0, 0)) / (long) 86400000);
    ...
    public String getLunarExceptYear() {

        StringBuffer sb = new StringBuffer();
        sb.setLength(7);

        if (month == 1) {
            sb.setCharAt(0, dateStr1[0]);
        } else {
            sb.setCharAt(0, dateStr1[month]);
        }
        sb.setCharAt(1, yearMonthDay[2]);

        if (day % 10 == 0) {
            if (10 == day) {
                sb.setCharAt(2, dateStr2[0]);
            } else {
                sb.setCharAt(2, dateStr1[day / 10]);
            }
            sb.setCharAt(3, dateStr1[10]);
        } else {
            sb.setCharAt(2, dateStr2[day / 10]);
            sb.setCharAt(3, dateStr1[day % 10]);
        }

        if (mSolarTime.monthDay == mCurMonthTerm1) {
            sb.setCharAt(4, solarTerm[mSolarTime.month * 4]);
            sb.setCharAt(5, solarTerm[mSolarTime.month * 4 + 1]);
        } else if (mSolarTime.monthDay == mCurMonthTerm2) {
            sb.setCharAt(4, solarTerm[mSolarTime.month * 4 + 2]);
            sb.setCharAt(5, solarTerm[mSolarTime.month * 4 + 3]);
        } else {
            sb.setCharAt(4, yearMonthDay[3]);
            sb.setCharAt(5, yearMonthDay[3]);
        }
        sb.setCharAt(6, ' ');
        return sb.toString();
    }
