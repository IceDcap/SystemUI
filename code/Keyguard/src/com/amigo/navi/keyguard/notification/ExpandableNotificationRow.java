    ...
    protected void onFinishInflate() {
        ...
        gutsStub.setOnInflateListener(new ViewStub.OnInflateListener() {
            ...
            public void onInflate(ViewStub stub, View inflated) {
            	if(inflated instanceof NotificationGuts){
...
//        mRowMaxHeight = rowMaxHeight;
    ...
    @Override
    protected boolean handleTouchEventDimmed(MotionEvent event) {
        if(MotionEvent.ACTION_UP == event.getActionMasked() && isExpanded()){
        	performClick();
        	return true;
        }
    	return super.handleTouchEventDimmed(event);
    }
}
