...
public class StatusBarIconView extends AnimatedImageView {
    ...
    private boolean updateDrawable(boolean withClear) {
        ...
        if (drawable == null) {
        	if(DebugLog.DEBUG) DebugLog.d(TAG, "No icon for slot " + mSlot);
            return false;
        }
        if (withClear) {
    ...
    public static Drawable getIcon(Context context, StatusBarIcon icon) {
        ...
        if (icon.iconPackage != null) {
            try {
            	...
            	DebugLog.e(TAG, "Icon package not found: " + icon.iconPackage);
                return null;
            }
        } else {
        ...
        try {
        	...
        	DebugLog.w(TAG, "Icon not found in "
    ...
    protected void debug(int depth) {
        super.debug(depth);
        if(DebugLog.DEBUG){
        	DebugLog.d("View", debugIndent(depth) + "slot=" + mSlot);
        	DebugLog.d("View", debugIndent(depth) + "icon=" + mIcon);
        }
    }
