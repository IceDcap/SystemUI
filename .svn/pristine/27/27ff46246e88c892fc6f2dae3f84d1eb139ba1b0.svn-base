 ...
 */
public class GnCameraController {
    ...
    /** Save for cameras available states */
    private HashMap<String, Boolean> mCameraAvailableMap = new HashMap<String, Boolean>();
    ...
    public GnCameraController(Context mContext) {
    ...
    public synchronized boolean isCameraAvailable() {
        ...
        for (Map.Entry<String, Boolean> entry : mCameraAvailableMap.entrySet()) {
    ...
    private String getCameraId() throws CameraAccessException {
        ...
        for (String id : ids) {
            mCameraAvailableMap.put(id, false);
        }
    ...
    private final CameraManager.AvailabilityCallback mAvailabilityCallback =
        ...
        public void onCameraAvailable(String cameraId) {
            ...
            setCameraAvailable(cameraId, true);
        }
        ...
        public void onCameraUnavailable(String cameraId) {
            ...
            setCameraAvailable(cameraId, false);
        }

        private void setCameraAvailable(boolean available) {
            boolean changed;
            synchronized (GnCameraController.this) {
        ...
        private void setCameraAvailable(String cameraId, boolean available) {
            mCameraAvailableMap.put(cameraId, available);
        }
    };
